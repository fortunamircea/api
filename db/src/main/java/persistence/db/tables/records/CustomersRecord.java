...
public class CustomersRecord extends UpdatableRecordImpl<CustomersRecord> implements Record7<UUID, String, String, String, String, LocalDateTime, LocalDateTime> {
    ...
    /**
     * Setter for <code>public.customers.token</code>.
     */
    ...
    /**
     * Getter for <code>public.customers.token</code>.
     */
    ...
    public Field<String> field5() {
        return Customers.CUSTOMERS.TOKEN;
    }
    ...
    @Override
    public CustomersRecord values(UUID value1, String value2, String value3, String value4, String value5, LocalDateTime value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CustomersRecord(UUID id, String firstName, String lastName, String email, String token, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Customers.CUSTOMERS);
